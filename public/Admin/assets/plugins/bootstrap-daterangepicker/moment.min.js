!function (e, t) {
    ...
    var ft = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
        ...
        _t = /Z|[+-]\d\d(?::?\d\d)?/,
        yt = [["DD-MM-YYYYYY", /[+-]\d{6}-\d\d-\d\d/], ["DD-MM-YYYY", /\d{4}-\d\d-\d\d/], ["GGGG-[W]WW-E", /\d{4}-W\d\d-\d/], ["GGGG-[W]WW", /\d{4}-W\d\d/, !1], ["YYYY-DDD", /\d{4}-\d{3}/], ["YYYY-MM", /\d{4}-\d\d/, !1], ["YYYYYYMMDD", /[+-]\d{10}/], ["DDMMYYYY", /\d{8}/], ["GGGG[W]WWE", /\d{4}W\d{3}/], ["GGGG[W]WW", /\d{4}W\d{2}/, !1], ["YYYYDDD", /\d{7}/]],
    ...
    c.defaultFormat = "DD-MM-YYYYTHH:mm:ssZ", c.defaultFormatUtc = "DD-MM-YYYYTHH:mm:ss[Z]";
    ...
    ln.add = qt, ln.calendar = function (e, t) {
        ...
        return n.year() < 0 || 9999 < n.year() ? A(n, t ? "DD-MM-YYYYYY[T]HH:mm:ss.SSS[Z]" : "DD-MM-YYYYYY[T]HH:mm:ss.SSSZ") : x(Date.prototype.toISOString) ? t ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", A(n, "Z")) : A(n, t ? "DD-MM-YYYY[T]HH:mm:ss.SSS[Z]" : "DD-MM-YYYY[T]HH:mm:ss.SSSZ")
    }, ln.inspect = function () {
    ...
    return In.isValid = function () {
        ...
        DATETIME_LOCAL: "DD-MM-YYYYTHH:mm",
        DATETIME_LOCAL_SECONDS: "DD-MM-YYYYTHH:mm:ss",
        DATETIME_LOCAL_MS: "DD-MM-YYYYTHH:mm:ss.SSS",
        DATE: "DD-MM-YYYY",
        TIME: "HH:mm",
