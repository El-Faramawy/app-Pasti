        ...
        @if(in_array(39,admin()->user()->permission_ids))
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#">
                    ...
                    <span href="{{route('orders.index')}}" class="side-menu__label">Ordini</span>
                    <i class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu">
                    <li><a href="{{route('orders.index')}}" class="slide-item"> ordini Collaboratori</a></li>
                    <li><a href="{{route('school_single_orders')}}" class="slide-item"> ordini aziendali</a></li>                </ul>
            </li>
