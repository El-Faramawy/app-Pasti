<!--begin::Form-->
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('schedule_notifications.store')}}">
    @csrf
    <div class="row mt-0">
        <!--begin::Input group-->
        ...
        <div class=" mb-2  col-sm-12 mt-0 ">
            ...
            <!--end::Label-->
            <input type="text" class="form-control form-control-solid" placeholder="il messaggio" name="message" value=""/>
        </div>
        <!--end::Input group-->
        ...
        <div class=" mb-2  col-sm-6 mt-0 ">
            ...
            <!--end::Label-->
            <input type="time" class="form-control form-control-solid" placeholder="tempo" name="time" value=""/>
        </div>
        <!--end::Input group-->
        <!--begin::Input group-->
        <div class="d-flex flex-column mb-2 fv-row col-sm-6 mt-0 ">
            <!--begin::Label-->
            <label class="d-flex align-items-center fs-6 fw-bold form-label ">
                <span class="required">alle richieste degli studenti </span>
                <i class="fa fa-exclamation-circle ms-2 fs-7 text-primary " title=" alle richieste degli studenti "></i>
            </label>
            <!--end::Label-->
            <div class="d-flex align-items-center mb-3 mt-3">
                <div class="material-switch pull-left">
                    <input id="someSwitchOptionPrimary" name="is_order" type="checkbox"/>
